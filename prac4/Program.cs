...
namespace prac4
{
    internal class Program
    {
        ...
        static Z4m3tk1 add()
        {
            ...
            Console.WriteLine("Введите дату, на которую будет назначена заметка (вводите дату в формате 'дд.мм.гггг', например 01.01.0001: ");
            ...
            double data0 = Convert.ToDouble(num_split[0]);
            double data1 = Convert.ToDouble(num_split[1]);
            double data2 = Convert.ToDouble(num_split[2]);
            int visok = 0;
            if (data2 % 4 == 0)
                visok = 1;
